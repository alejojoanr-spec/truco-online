...
export function MesaJuego({
  ...
  return (
    ...
    <div style={{
      ...
      {/* Mesa — 3 slots fijos */}
      <div style={{ background:"#12584d", border:"1px solid rgba(45,106,79,0.4)", borderRadius:16, padding:"10px 16px", display:"flex", alignItems:"center", justifyContent:"center", gap:14, width:"100%", maxWidth: esMobile ? 300 : 420, margin:"0 auto", marginTop:PANO_MARGIN_TOP, flexGrow:1, minHeight:240, maxHeight:240 }}>
        {rondas.map((r, ri) => (
