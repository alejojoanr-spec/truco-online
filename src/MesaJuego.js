  ...
  return (
    ...
    <div style={{
      ...
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", flexShrink:0, marginTop:-86, minHeight:185 }}>
        <div style={{ position:"relative", display:"inline-flex", alignItems:"flex-end", justifyContent:"center", minWidth:220, minHeight:175 }}>
      ...
      <div style={{
        ...
        <div style={{ display:"flex", flexWrap:"wrap", gap:8, justifyContent:"center", alignItems:"center", alignContent:"center", width:"100%", maxWidth:500, margin:"0 auto", minHeight:140 }}>
          {botonesSlot}
        </div>
      </div>
